            ...
            <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">
                        Tanggal: {{ \Carbon\Carbon::parse($stockDate)->locale('id')->isoFormat('dddd, D MMMM Y') }}
                    </p>
                </div>
