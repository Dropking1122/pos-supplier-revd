                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <a href="{{ route('sales.invoice-customer', $sale->id) }}" target="_blank" class="inline-flex items-center gap-1 text-sky-600 hover:text-sky-800 text-xs bg-sky-50 hover:bg-sky-100 px-2 py-1 rounded transition-colors mr-1">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                Invoice
                            </a>
                            <a href="{{ route('sales.invoice', $sale->id) }}" target="_blank" class="inline-flex items-center gap-1 text-slate-600 hover:text-slate-800 text-xs bg-slate-50 hover:bg-slate-100 px-2 py-1 rounded transition-colors mr-1">
